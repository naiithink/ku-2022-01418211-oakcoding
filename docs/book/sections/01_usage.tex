...
\oakparimagehere{sections/images/01/01-06_admin-home.png}

ผู้ใช้ Admin สามารถดูรายชื่อของผู้ใช้งานทั้งหมดได้โดยเลือก ``Users'' ที่แถบด้านข้าง

\oakparimagehere{sections/images/01/01-07_admin-all-users.png}

\pagebreak[4]

\oaksimsec{สร้างบัญชีผู้ใช้ Staff}

\oakparimagehere{sections/images/01/01-08_admin-register-staff.png}
...
\oakparimagehere{sections/images/01/01-09_admin-all-complaints.png}
...
\oakparimagehere{sections/images/01/01-10_admin-create-dep.png}
...
\oakparimagehere{sections/images/01/01-11_staff-home.png}

ผู้ใช้ Staff สามารถจัดการเรื่องร้องเรียนภายในหมวดหมู่ที่ถูกมอบหมายแก่หน่วยงานที่เป็นสมาชิกอยู่เท่านั้น

\oakparimagehere{sections/images/01/01-12_staff-all-complaints.png}
...
\oakparimagehere{sections/images/01/01-13_consumer-home.png}

\oaksimsec{เข้าถึงและแจ้งเรื่องร้องเรียน}

\oakparimagehere{sections/images/01/01-14_consumer-all-complaints.png}
...
\oakparimagehere{sections/images/01/01-15_consumer-file-new-complaint.png}
...
\oakparimagehere{sections/images/01/01-16_consumer-complaint-details.png}
