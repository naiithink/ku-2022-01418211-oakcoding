...
ระดับสิทธิ์ของผู้ใช้ประกอบด้วย 3 ระดับ \marginnote{ในปัจจุบัน บัญชีผู้ใช้ที่ถูกสร้างขึ้นในระบบจะไม่สามารถลบออกได้} ได้แก่ ผู้ดูแลระบบ, เจ้าหน้าที่, และนิสิต
...
โดยที่ $time \in [0, 2^{63}-1]$\marginnote{ข้อมูลประเภท \texttt{long} ใน Java สามารถเก็บค่าได้ในช่วง $[-2^{63}, 2^{63}-1]$ \mbox{\cite[JSL \S 4.2.1]{jsl-4.2.1}}} represent เวลาในระบบ UNIX ซึ่งเป็นเวลาที่
