...
header\marginpar{header ของตารางของไฟล์ CSV ใน project จะถูกเขียนด้วยตัวอักษรภาษาอังกฤษตัวพิมพ์ใหญ่ (uppercase) ทั้งหมด และไม่มีตัวอักษรว่าง (space)} ของตารางมีเอาไว้เพื่อกำหนดว่าข้อมูลใน column/field นั้น ๆ คืออะไร
