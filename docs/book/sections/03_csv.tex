...
\subsubsection{\texorpdfstring{$ F_{1} $}{File \#1}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/deps/\\DEPARTMENT/info.csv}}}{deps/DEPARTMENT/info.csv}}\label{subsubsec:csv-f1}
\phantomsection
...
% F2
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{2} $}{File \#2}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/deps/\\DEPARTMENT/members.csv}}}{deps/DEPARTMENT/members.csv}}\label{subsubsec:csv-f2}
\phantomsection
...
% F3
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{3} $}{File \#3}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/deps/\\DEPARTMENT/tags.csv}}}{data/deps/DEPARTMENT/tags.csv}}\label{subsubsec:csv-f3}
\phantomsection
...
% F4
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{4} $}{File \#4}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/deps/\\deps.csv}}}{deps/deps.csv}}\label{subsubsec:csv-f4}
\phantomsection
...
% F5
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{5} $}{File \#5}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/issues/\\complaints/evidences/evidences.csv}}}{issues/complaints/evidences/evidences.csv}}\label{subsubsec:csv-f5}
\phantomsection
...
% F6
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{6} $}{File \#6}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/issues/\\complaints/categories.csv}}}{issues/complaints/categories.csv}}\label{subsubsec:csv-f6}
\phantomsection
...
% F7
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{7} $}{File \#7}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/issues/\\complaints/complaints.csv}}}{issues/complaints/complaints.csv}}\label{subsubsec:csv-f7}
\phantomsection
...
% F8
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{8} $}{File \#8}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/issues/\\reports/reports.csv}}}{issues/reports/reports.csv}}\label{subsubsec:csv-f8}
\phantomsection
...
% F9
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{9} $}{File \#9}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/users/\\USER/info.csv}}}{users/USER/info.csv}}\label{subsubsec:csv-f9}
\phantomsection
...
6               & USING\textunderscore{}DEFAULT \textunderscore{}PROFILE\textunderscore{}IMAGE      & ใช้รูป profile เป็นรูปตั้งต้นของระบบใช้หรือไม่ --- \texttt{true} หรือ \texttt{false} ตามลำดับ\\
...
% F10
\begin{minipage}{\textwidth}
\subsubsection{\texorpdfstring{$ F_{10} $}{File \#10}: \texorpdfstring{\parbox[t]{0.5\textwidth}{\texttt{data/users/requests.csv}}}{users/requests.csv}}\label{subsubsec:csv-f10}
\phantomsection
