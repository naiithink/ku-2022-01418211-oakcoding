...
header\marginnote{header ของตารางของไฟล์ CSV ใน project จะอยู่ที่บรรทัดแรกของไฟล์เสมอและจะถูกเขียนในรูปแบบ SCREAMING\textunderscore{}SNAKE\textunderscore{}CASE} ของตารางมีเอาไว้เพื่อกำหนดว่าข้อมูลใน column/field นั้น ๆ คืออะไร
