...
public enum OakAppDefaults {
    ...
    APP_COMPLAINT_FILE              ("app.complaints.file",                 "complaints.csv"),
    APP_COMPLAINT_CATEGORIES_FILE   ("app.complaints.categories.file",      "complaint_categories.csv"),
    APP_REPORT_FILE                 ("app.reports.file",                    "reports.csv"),
