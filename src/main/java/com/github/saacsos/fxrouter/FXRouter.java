...
public class FXRouter {
    ...
    protected static final Double WINDOW_WIDTH = 800.0D;
    protected static final Double WINDOW_HEIGHT = 600.0D;
    protected static final Double FADE_ANIMATION_DURATION = 800.0D;
    protected static FXRouter router;
    protected static Object mainRef;
    protected static Stage window;
    protected static String windowTitle;
    protected static Double windowWidth;
    protected static Double windowHeight;
    protected static String animationType;
    protected static Double animationDuration;
    ...
    protected static void loadNewRoute(RouteScene route) throws IOException {
        currentRoute = route;
